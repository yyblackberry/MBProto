...
{
    TLObject period_ = TLObject::read(reader);
    TLObject followers_ = TLObject::read(reader);
    TLObject views_per_post_ = TLObject::read(reader);
    TLObject shares_per_post_ = TLObject::read(reader);
    TLObject enabled_notifications_ = TLObject::read(reader);
    TLObject growth_graph_ = TLObject::read(reader);
    TLObject followers_graph_ = TLObject::read(reader);
    TLObject mute_graph_ = TLObject::read(reader);
    TLObject top_hours_graph_ = TLObject::read(reader);
    TLObject interactions_graph_ = TLObject::read(reader);
    TLObject iv_interactions_graph_ = TLObject::read(reader);
    TLObject views_by_source_graph_ = TLObject::read(reader);
    TLObject new_followers_by_source_graph_ = TLObject::read(reader);
    TLObject languages_graph_ = TLObject::read(reader);
    std::vector<TLObject> recent_message_interactions_ = Vector<TLObject>::read(reader);
...
{
    TLObject period_ = TLObject::read(reader);
    TLObject members_ = TLObject::read(reader);
    TLObject messages_ = TLObject::read(reader);
    TLObject viewers_ = TLObject::read(reader);
    TLObject posters_ = TLObject::read(reader);
    TLObject growth_graph_ = TLObject::read(reader);
    TLObject members_graph_ = TLObject::read(reader);
    TLObject new_members_by_source_graph_ = TLObject::read(reader);
    TLObject languages_graph_ = TLObject::read(reader);
    TLObject messages_graph_ = TLObject::read(reader);
    TLObject actions_graph_ = TLObject::read(reader);
    TLObject top_hours_graph_ = TLObject::read(reader);
    TLObject weekdays_graph_ = TLObject::read(reader);
    std::vector<TLObject> top_posters_ = Vector<TLObject>::read(reader);
    std::vector<TLObject> top_admins_ = Vector<TLObject>::read(reader);
    std::vector<TLObject> top_inviters_ = Vector<TLObject>::read(reader);
...
{
    TLObject views_graph_ = TLObject::read(reader);
